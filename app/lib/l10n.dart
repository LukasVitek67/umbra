...
class L {
  ...
  static const Map<String, Map<String, String>> _strings = {
    'en': {
      ...
      'msg.reply': 'Reply',
      'reply.gone': 'the message this answers is not here',
      'mention.hint': 'Type @ to mention someone',
      'media.title': 'Media',
      'media.subtitle': 'Everything sent and received as a file',
      'media.refresh': 'Reload',
      'media.searchHint': 'Search by name or person',
      ...
      'media.files': 'Files',
      'media.empty':
          'Nothing here yet. Files you send or receive collect in this list.',
      'media.noMatch': 'Nothing matches.',
      'media.unnamed': 'Unnamed file',
    ...
    'cs': {
      ...
      'msg.reply': 'Odpovědět',
      'reply.gone': 'zpráva, na kterou odpovídá, tu není',
      'mention.hint': 'Napiš @ a označ někoho',
      'media.title': 'Média',
      'media.subtitle': 'Všechno odeslané i přijaté jako soubor',
      'media.refresh': 'Načíst znovu',
      'media.searchHint': 'Hledat podle názvu nebo člověka',
      'media.all': 'Vše',
      'media.photos': 'Fotky',
      'media.videos': 'Videa',
      'media.gifs': 'GIFy',
      'media.files': 'Soubory',
      'media.empty':
          'Zatím tu nic není. Soubory, které pošleš nebo dostaneš, se sbírají sem.',
      'media.noMatch': 'Nic neodpovídá.',
      'media.unnamed': 'Soubor bez názvu',
